...
#v(1fr)
#align(center)[
  #text(9.5pt, fill: c-light-gray)[Project repository: https://github.com/AdrianParry-17/AI-App-Map-Search]
]
#v(0.5cm)
...
#figure(
  align(center)[#table(
    ...
    [Class / section], [`24C03`],
    [Project
    repository], [`https://github.com/AdrianParry-17/AI-App-Map-Search`],
